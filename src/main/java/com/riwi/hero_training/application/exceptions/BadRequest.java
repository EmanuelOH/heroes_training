...
import com.riwi.hero_training.application.dtos.exceptions.ExceptionsResponse;
...
@RestControllerAdvice //Esta anotacion sirve para darle un manejo a las excepciones globales en los controladores REST
@ResponseStatus(code = HttpStatus.BAD_REQUEST) //Define el error
