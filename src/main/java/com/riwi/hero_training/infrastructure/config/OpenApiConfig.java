...
@OpenAPIDefinition(info = @Info(
    ...
    servers = {
            ...
            @Server(url = "http://localhost:8080/v1", description = "Server local")
    }
)
    ...
    public OpenAPI customOpenApi(){
        return new OpenAPI()
                ...
                .info(new io.swagger.v3.oas.models.info.Info() //Informacion adicional de la API
                        ...
                        .description("API for the management of skills and missions") //Description de la api
                        .contact(new io.swagger.v3.oas.models.info.Contact() //Info del contacto
                                .name("Example")
